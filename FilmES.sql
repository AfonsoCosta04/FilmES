...
CREATE TABLE `aluguer` (
    ...
    INSERT INTO `aluguer`(`id_aluguer`,`id_filme`,`id_cliente`,`data_levantamento`,`data_devolucao`,`estado`)VALUES
		(1,1,7,'2025-05-10','2025-05-15', 'devolvido'),
        (2,2,7,'2025-05-10','2025-05-15', 'devolvido'),
        (3,3,7,'2025-05-10','2025-05-15', 'devolvido'),
        (4,4,7,'2025-05-10','2025-05-15', 'devolvido'),
        (5,5,7,'2025-05-10','2025-05-15', 'devolvido'),
        (6,6,7,'2025-05-10','2025-05-15', 'devolvido');
...
ALTER TABLE `aluguer`
	ADD CONSTRAINT `aluguer_ibfk_1` FOREIGN KEY (`id_filme`) REFERENCES `filme`(`id_filme`)	,
    ADD CONSTRAINT `aluguer_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `cliente`(`id_cliente`);
