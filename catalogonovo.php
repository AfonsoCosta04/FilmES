...
<body class="catalogo-body">
    <header>
        ...
        <div class="auth">
            <span><?php echo htmlspecialchars($_SESSION['nome_cliente']); ?></span> 
        </div>
    </header>
    ...
    <div class="catalogo-container">
        ...
        <section class="catalogo-filmes">
            <div class="catalogo-filme">
                <a href="produto.html" class="catalogo-link">
                    <img src="imagens/deadpool.jpeg" alt="Deadpool & Wolverine">
                    <div class="catalogo-info">
                        <h3>Deadpool & Wolverine</h3>
                        <span class="catalogo-status">🔴 Indisponível</span>
                    </div>
                </a>
                <button class="catalogo-ver-filme indisponivel">Ver Filme</button>
            </div>

            <div class="catalogo-filme">
                <a href="produto.html" class="catalogo-link">
                    <img src="imagens/Duna.jpg" alt="Dune: Part 2">
                    <div class="catalogo-info">
                        <h3>Dune: Part 2</h3>
                        <span class="catalogo-status">🟢 Disponível</span>
                    </div>
                </a>
                <a href="carrinho.html" class="catalogo-ver-filme disponivel">ALUGUER RÁPIDO</a>
            </div>
